  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Builder(builder: (BuildContext context) {
        return WebView(
          initialUrl: 'https://ramazanbayborek.com',
          ...
          if (controller.hasData) {
            return FloatingActionButton(
              ...
              onPressed: () async {
                ...
                if(ctr%2==0) {
                  Scaffold.of(context).showSnackBar(
                    SnackBar(content: Text('Favorited $url', style: TextStyle(color: Colors.amberAccent),)),
                  );
                } else {
                  Scaffold.of(context).showSnackBar(
                    SnackBar(content: Text('Unfavorited $url', style: TextStyle(color: Colors.amberAccent),)),
                  );
                }
                setState(() {
                  ctr++;
              ...
              child: Icon(Icons.favorite,
                  color: ctr%2==1 ? Colors.amberAccent : Colors.white),
            );
          }
          return Container();
        });
