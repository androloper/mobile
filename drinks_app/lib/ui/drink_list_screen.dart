...
import 'package:drinks_app/ui/ingredient_screen.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

class DrinkListScreen extends StatefulWidget {
  String? name;
  DrinkListScreen({required this.name,Key? key}) : super(key: key);
...
class _DrinkListScreenState extends State<DrinkListScreen> {
  final List<dynamic>? drinks = Apis.drinkByCategory;
              ...
              child: _foundDrinks!.isNotEmpty
                  ...
                  itemBuilder: (context, index) => Card(
                    ...
                    child: ListTile(
                      ...
                      // title:Text(_foundDrinks![index]["strDrink"].toString().toUpperCase(), style: TextStyle(color: Colors.amberAccent)),
                      onTap: () async {
